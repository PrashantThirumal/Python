I used python here to control a iCreate2 Roomba.
A raspberry pi was attached to the roomba and the python code was implemented on the raspberry pi to control the movements of the Roomba
The pdf files are the task descriptions
